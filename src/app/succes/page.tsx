  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      ...
      <div onClick={copierCode} style={{
        background: '#111827', border: `2px solid ${copie ? '#00C853' : '#00A8FF'}`,
        borderRadius: '12px', padding: '20px 32px', marginBottom: '16px',
        cursor: 'pointer', textAlign: 'center', width: '100%', maxWidth: '320px',
        animation: 'fadeUp 0.5s ease 0.4s both', transition: 'border-color 0.3s ease',
      }}>
      ...
      <div style={{
        background: '#111827', border: '1px solid #1E3A5F', borderRadius: '12px',
